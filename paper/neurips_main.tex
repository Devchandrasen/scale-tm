...
The implementation, result artifacts, and paper source are available at \url{https://github.com/Devchandrasen/scale-tm}. The experiments are implemented in four scripts. Protocol A is reproduced by running:
\begin{verbatim}
